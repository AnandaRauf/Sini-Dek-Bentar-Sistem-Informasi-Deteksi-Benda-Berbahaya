...
import 'package:deteksibendaberbahaya/tflite/recognition.dart';
...
class Classifier {
  ...
  static const String MODEL_FILE_NAME = "assets/model_unquant.tflite";
  static const String LABEL_FILE_NAME = "assets/label.txt";
  static const String MODEL_FILE_NAME2 = "assets/detect.tflite";
  static const String LABEL_FILE_NAME2 = "assets/labelmap.txt";
  ...
  void loadLabels({List<String> labels}) async {
    try {
      _labels = labels ?? await FileUtil.loadLabels("assets/" + LABEL_FILE_NAME + LABEL_FILE_NAME2);
    } catch (e) {
